...
public class FileUser  {
    ...
    public FileUser doCopy(String pathOfCopy) throws IOException {
        return new FileUser(pathOfCopy);
    }
    public FileUser doRename(String  newName) throws IOException {
        FileUser local = this.doCopy(newName);
        file.delete();
        return local;
    }

    public void doGetPath() throws IOException {
