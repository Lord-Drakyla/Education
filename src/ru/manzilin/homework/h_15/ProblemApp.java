package ru.manzilin.homework.h_15;

import ru.manzilin.homework.h_15.Task1.FileUser;
import ru.manzilin.homework.h_15.Task1.FileUserRun;
import ru.manzilin.homework.h_15.Task2.RecurseUser;
...
public class ProblemApp {
    ...
    public static void main(String[] args) {
        ...
        ProblemPathTask2.PathPrint(pFile);
        try{
