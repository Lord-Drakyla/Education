...
class MainTest {
    private static String[] source= new String[]{"foo", "buzz", "bar", "fork", "bort", "spoon", "!", "dude", null};
    ...
    void removeEvenLength() {
        ...
        assertEquals(expectedSet,sourceSet, "Должны остаться только слова с нечетным количеством символов");
    }
